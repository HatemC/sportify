...
# alice_event = Event.new(sport: 'Tennis', level: 'Advanced', date: '09 May 2022')
# alice_event.user = alice
# alice_event.address = alice.address
# alice_event.save!

# jean_event = Event.new(language: 'French', level: 'Native', date: 'Monday', duration: '1 hour')
# jean_event.user = jean
# jean_event.address = jean.address
# jean_event.save!

# chloe_event = Event.new(language: 'French', level: 'Native', date: 'Monday', duration: '1 hour')
