...
duration =['0,5 hour', '1 hour', '1,5 hour']
...
alice_event = Event.new(sport: 'Tennis', level: 'Advanced', date: '09 May 2022', duration: '1 hour')
alice_event.user = alice
# alice_event.address = alice.address
alice_event.save!

jean_event = Event.new(sport: 'Football', level: 'Advanced', date: 'Monday', duration: '1 hour')
jean_event.user = jean
# jean_event.address = jean.address
jean_event.save!

chloe_event = Event.new(sport: 'Basketball', level: 'Advanced', date: 'Monday', duration: '1 hour')
